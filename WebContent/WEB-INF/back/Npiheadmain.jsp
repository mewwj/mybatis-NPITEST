                                                        ...
                                                        <!--內容框Start-->
                                                           ...
                                                           <table style="width: 100%; padding: 5 5 5 5; border: solid 1px #a9c9ee" cellpadding="0"  cellspacing="0">     
                                                                <tr style="height:30px;">
                                                                    ...
                                                                    <td style="width:30%">
                                                                       <input type="text"  id="InputkehuName" name="zcusname" >
                                                                    </td>
                                                                    <td style="width:13%; text-align:right;">
                                                                                                                                                                                                专案名称：
                                                                    </td>
                                                                    <td style="width:30%">
                                                                       <input type="text"  id="InputzhuananName" name="zproname"  >
                                                                    </td>
                                                                </tr> 
																	...
																	<tr align="center">
																	 ...
																	 <c:forEach items="${mainheadlist}" var="item" varStatus="status"> 
																	  	...
																	  	<td class="dgdatagridTdNewStyle" style="text-align:center;">
																		   <a href="/npi.test/HEAD_DoHeadMain?iid=${item.id}">添加检讨信息</a>&nbsp;<a href="/npi.test/ITEM_ToItemsMain?zid=${item.id}">查看检讨信息</a> 
																	    </td>
																  		</tr>
																    	</c:forEach>																
																</table>                                                                                                                                                      
